      ...
      <div class="col-sm-6">
          <table>
            ...
            <tr>
              ...
              <td><h4>Rs.<?php echo $rows['estimated_price']; ?>/Year</h4></td>
            </tr>
          </table>
        </div>
      </div>
...
<div class="row">
  <div class="col-sm-6">
    ...
    <input type="submit" class="btn btn-lg btn-primary"  style="width: 100%" value="Book Property">
  <?php } else { ?>
    <input type="submit" class="btn btn-lg btn-primary" style="width: 100%" value="Property Booked" disabled>
  <?php } ?>
  </div>
</form>
<form method="POST" action="chat/chatpage2.php">
  <div class="col-sm-6">
