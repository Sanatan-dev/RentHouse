...
<form method="POST" enctype="multipart/form-data">
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="form-group">
        <label for="vdc_municipality">Municipality:</label>
        <select class="form-control" name="vdc_municipality" required="required">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="ward_no" placeholder="Enter Ward No." name="ward_no" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="estimated_price" placeholder="Enter Estimated Price" name="estimated_price" required>
      </div>
    </div>
    ...
    <div class="col-sm-6">
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="total_rooms" placeholder="Enter Total No. of Rooms" name="total_rooms" required>
      </div>

      <div class="form-group">
        <label for="bedroom">No. of Bedroom:</label>
        <input type="number" class="form-control" id="bedroom" placeholder="Enter No. of Bedroom" name="bedroom" required>
      </div>

      <div class="form-group">
        <label for="living_room">No. of Living Room:</label>
        <input type="number" class="form-control" id="living_room" placeholder="Enter No. of Living Room" name="living_room" required>
      </div>

      <div class="form-group">
        <label for="kitchen">No. of Kitchen:</label>
        <input type="number" class="form-control" id="kitchen" placeholder="Enter No. of Kitchen" name="kitchen" required>
      </div>

      <div class="form-group">
        <label for="bathroom">No. of Bathroom/Washroom:</label>
        <input type="number" class="form-control" id="bathroom" placeholder="Enter No. of Bathroom/Washroom" name="bathroom" required>
      </div>
    ...
    <div id="menu2" class="tab-pane fade">
        ...
        if(mysqli_num_rows($result1)>0)
      {
        ...
        $sql="SELECT * from add_property where owner_id='$owner_id' and approved = 1";
        $result=mysqli_query($db,$sql);
...
<!-- Edit property section starts here (not the table though.) -->
...
<div id="map_canvas"></div>
        ...
        <div class="col-sm-6">
        <div class="form-group">
              <label for="ward_no"> Id </label>
              <input type="text" class="form-control" id="property_id" placeholder="Enter property id." name="property_id" >
            </div>
        <div class="form-group">
        <label for="country">Country:</label>
        <select class="form-control" name="country" required="required">
    ...
    <!-- Additional Information -->
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="description" placeholder="Enter Property Description" name="description"></textarea>
                  ...
                  <hr>
                  <div class="form-group">
                    <input type="submit" class="btn btn-primary btn-lg col-lg-12" value="Update" name="update_property">
                  </div>
                </div>
              </div>
              </form>
...
<!-- This is booking property section. -->
        ...
        $sql3="SELECT * from owner where email='$u_email'";
            ...
            if(mysqli_num_rows($result3)>0)
          {
              while($rowss=mysqli_fetch_assoc($result3)){
                ...
                $sql2="SELECT * from add_property where owner_id='$owner_id' and approved=1";
...
<!-- This below code is used to filter through the table to search the item in search function. -->
<script>
...
<script>
  //Search and filter through update_property table.
              ...
              <script>
                //Search and filter through booking table.
              ...
              <script>  
              //This function is used when more photos are to be added 
 $(document).ready(function(){  
      ...
      // This function removes the row of the photos that were added using onclick event.
      $(document).on('click', '.btn_remove', function(){  
           var button_id = $(this).attr("id");   
           $('#row'+button_id+'').remove();  
      }); 
      
      //This function is called when submit function is called in add_property page.
