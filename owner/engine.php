...
<div class="alert" role='alert'>
  ...
  <center><strong>Your Property has been listed for Admin's Approval.</strong></center>
</div></div>
...
function update_property(){
	...
	global $property_id,$country,$province,$zone,$district,$city,$vdc_municipality,$ward_no,$tole,$contact_no,$property_type,$estimated_price,$total_rooms,$bedroom,$living_room,$kitchen,$bathroom,$description,$db;
...
function delete_property(){
	...
	$delete_photos_query = "DELETE FROM property_photo WHERE property_id = '$property_id'";
    
    if (empty(mysqli_query($db, $delete_photos_query))) {
		echo "Error deleting property: " . mysqli_error($db);
		return;
    } 
	$delete_property_query = "DELETE FROM add_property WHERE property_id = '$property_id'";
	mysqli_query($db, $delete_property_query);

		if(!empty($delete_property_query)){
			?>
...
<div class="alert" role='alert'>
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <center><strong>Your Information has been Deleted.</strong></center>
</div></div>
